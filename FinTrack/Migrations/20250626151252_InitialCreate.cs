        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                    MessageHead = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    MessageBody = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_User",
                table: "Budgets",
                column: "User");

            migrationBuilder.CreateIndex(
                name: "IX_Categories_User_CategoryName_CategoryType",
                table: "Categories",
                columns: new[] { "User", "CategoryName", "CategoryType" },
                unique: true);
